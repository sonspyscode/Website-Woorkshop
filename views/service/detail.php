					...
					<div class="col-sm-8">
						<div class="card shadow">
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-primary">Detail Service - <?= $service->nama ?></h6>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-6">
										<img src="<?= base_url('uploads/' . $service->gambar) ?>" alt="<?= $service->nama ?>" class="img-thumbnail mb-4">
									</div>
									<div class="col-md-6">
										<table class="table table-borderless">
											<tr>
												<td>Nama</td>
												<td>:</td>
												<td><b><?= $service->nama ?></b></td>
											</tr>
											<tr>
												<td>Cabang</td>
												<td>:</td>
												<td><b><?= $service->cabang ?></b></td>
											</tr>
											<tr>
												<td>Jenis Kendaraan</td>
												<td>:</td>
												<td><b><?= $service->jeniskndrn ?></b></td>
											</tr>
											<tr>
												<td>Jumlah Teknisi</td>
												<td>:</td>
												<td><b><?= $service->jumlah_tkns ?> Teknisi</b></td>
											</tr>
											<tr>
												<td>Estimasi Biaya</td>
												<td>:</td>
												<td><b> Rp <?= $service-> biaya ?></b></td>
											</tr>
										</table>	
									</div>				
								</div>
								<div class="row">
									<div class="col">
										...
										<a href="<?= base_url('service') ?>" class="btn btn-sm btn-secondary"><i class="fa fa-reply"></i> Kembali</a>
									</div>
								</div>
							</div>
						</div>
