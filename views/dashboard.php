						...
						<div class="card border-left-primary shadow h-100 py-2">
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<div class="col mr-2">
										<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Service</div>
										<div class="h5 mb-0 font-weight-bold text-gray-800"><?php print_r($service->num_rows) ?> Service</div>
									</div>
									<div class="col-auto">
							...
							<div class="card-body">
								<div class="row no-gutters align-items-center">
									<!-- <div class="col mr-2">
										...
										<div class="h5 mb-0 font-weight-bold text-gray-800"><?= $member->num_rows ?> Member</div>
									</div> -->
									<div class="col-auto">
