				...
				<div class="row">
					<div class="col-sm-4">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('cabang/tambah') ?>">
								  	<div class="form-group">
										<label for="cabang">Nama Cabang</label>
										<input type="text" class="form-control" name="cabang" id="cabang" autocomplete="off" required="required" placeholder="ketik">
								  	</div>
								  	<div class="form-group">
	                 				...
	                 				<tbody>
	                 					<?php while($cabang = $data_cabang->fetch_object()) : ?>
	                 						<tr>
	                 							...
	                 							<td><?= $cabang->cabang ?></td>
	                 							<td>
	                 								<a href="<?= base_url('cabang/ubah/' . $cabang->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
	                 								<a href="<?= base_url('cabang/hapus/' . $cabang->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
	                 							</td>
	                 						</tr>
	                 					<?php endwhile; ?>
	                 				</tbody>
