					...
					<div class="col-sm-12">
						<div class="clearfix">
							<div class="float-left">
								<h1 class="h3 mb-4 text-gray-800">Ubah Data Member</h1>
							</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('member/proses_ubah/' . $member->id) ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		<label for="nama">Nama Member</label>
								  		<input type="text" value="<?= $member->nama ?>" name="nama" id="nama" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
									<div class="form-group">
								  		<label for="nama">Nomor Handphone</label>
								  		<input type="text" value="<?= $member->nohp ?>" name="nohp" id="nohp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
									...
									<div class="form-group">
								  		...
								  		<textarea name="alamat" id="alamat" rows="3" class="form-control" placeholder="ketik"><?= $member->alamat ?></textarea>
								  	</div>
