				...
				<div class="row">
					<div class="col-sm-4">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('member/tambah') ?>" enctype="multipart/form-data">
									...
									<div class="form-group">
								  		...
								  		<input type="text" name="nohp" id="nohp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
						...
						<div class="card shadow">
							...
							<div class="card-body">
								...
								<table class="table table-bordered" id="dataTable" width="" cellspacing="0">
	                 				...
	                 				<tbody>
										<?php while($member = $data_member->fetch_object()) : ?>
											<tr>
												<td><?= $no++ ?></td>
												<td><?= $member->nama ?></td>
												<td><?= $member->nohp ?></td>
												...
												<td>
													<a href="<?= base_url('member/ubah/' . $member->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
													<a href="<?= base_url('member/detail/' . $member->id) ?>" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i> Detail</a>
	                 								<a href="<?= base_url('member/hapus/' . $member->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
												</td>
											</tr>
										<?php endwhile; ?>
									</tbody>
