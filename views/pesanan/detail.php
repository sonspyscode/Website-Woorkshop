					...
					<div class="col-md-6">
						<div class="card shadow">
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-primary"><?= $judul ?> - <?= $pesanan->nama_member ?></h6>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-sm-4">
									...
									<div class="col-sm-6">
										<strong><?= $pesanan->nama_member ?></strong><br>
										<strong><?= $pesanan->jam_service ?></strong><br>
										<strong><?= $pesanan->tgl_service ?></strong><br>
										<strong><?= $pesanan->nama_service ?></strong><br>
