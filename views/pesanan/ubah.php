							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pesanan/proses_ubah/' . $pesanan->id) ?>" enctype="multipart/form-data">
								  	<div class="form-group">
								  		...
								  		<input type="text" disabled="disabled" class="form-control" value="<?= $member->nama ?>">
								  	</div>

								  	<div class="form-group">
								  		<label for="id_mobil">Service</label>
								  		<input type="text" disabled="disabled" class="form-control" value="<?= $service->nama ?>">
								  	</div>
								  	...
								  	<div class="row">
								  		<div class="col-md-6">
								  			<div class="form-group">
										  		...
										  		<input type="text" name="jenis_bayar" id="jenis_bayar"  value="<?= $jenis_bayar->jenis_bayar ?>" placeholder="ketik" required="required" autocomplete="off" class="form-control">
										  	</div>
								  		</div>
								  		<div class="col-md-6">
								  			<div class="form-group">
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
										  		<label for="jam_service">Jam service</label>
										  		<input type="text" name="jam_service" id="jam_service" value="<?= $pesanan->jam_service ?>" placeholder="ketik" required="required" autocomplete="off" class="form-control">
										  	</div>
									  	</div>
										<div class="col-md-6">
											<div class="form-group">
										  		<label for="tgl_service">Tanggal Service</label>
										  		<input type="date" name="tgl_service" value="<?= $pesanan->tgl_service ?>" id="tgl_service" required="required" autocomplete="off" class="form-control">
										  	</div>
									  	</div>
									</div>
								  	<div class="form-group">
