									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
										  		...
										  		<input type="time" name="jam_service" id="jam_service" required="required" autocomplete="off" class="form-control">
										  	</div>
									  	</div>
										<div class="col-md-6">
											<div class="form-group">
										  		<label for="tgl_service">Tanggal Service</label>
										  		<input type="date" name="tgl_service" id="tgl_service" required="required" autocomplete="off" class="form-control">
										  	</div>
									  	</div>
									</div>
								  	<div class="form-group">
